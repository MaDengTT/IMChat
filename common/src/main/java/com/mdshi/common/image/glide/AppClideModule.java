...
import com.mdshi.common.utils.FolderManager;
 ...
 */
@GlideModule
public class AppClideModule extends AppGlideModule{
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        ...
        builder.setDiskCache(new DiskLruCacheFactory(FolderManager.getDiskCacheDir(context), "imageCache", imageDiskCacheSize));
    }
